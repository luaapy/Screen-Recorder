...
class MainWindow(ctk.CTk):
    def __init__(self, start_callback=None, stop_callback=None, pause_callback=None, resume_callback=None, config=None):
        ...
        self.configure(fg_color=("white", "#F5F5F5"))
        ...
        self.timer_label = ctk.CTkLabel(self.control_frame, text="00:00:00", font=ctk.CTkFont(size=36, weight="bold"))
    ...
    def _setup_general_tab(self):
        ...
        ctk.CTkLabel(self.mode_frame, text="Recording Mode:", font=ctk.CTkFont(weight="bold")).pack(anchor="w", padx=10, pady=5)
        self.record_mode = ctk.StringVar(value="Full Screen")
        ctk.CTkRadioButton(self.mode_frame, text="Full Screen", variable=self.record_mode, value="Full Screen").pack(anchor="w", padx=20, pady=2)
        ctk.CTkRadioButton(self.mode_frame, text="Select Region", variable=self.record_mode, value="Select Region").pack(anchor="w", padx=20, pady=2)

        # Output
        self.output_frame = ctk.CTkFrame(self.tab_general)
        self.output_frame.pack(fill="x", pady=10)
        ctk.CTkLabel(self.output_frame, text="Output Folder:", font=ctk.CTkFont(weight="bold")).pack(anchor="w", padx=10, pady=5)
        ...
        # Options
        self.chk_cursor = ctk.CTkCheckBox(self.tab_general, text="Show Cursor", onvalue=True, offvalue=False)
        self.chk_cursor.pack(anchor="w", padx=10, pady=5)
        if self.config.get("show_cursor"): self.chk_cursor.select()

        self.chk_countdown = ctk.CTkCheckBox(self.tab_general, text="Show Countdown (3s)", onvalue=True, offvalue=False)
    ...
    def _setup_video_tab(self):
        ctk.CTkLabel(self.tab_video, text="FPS:").grid(row=0, column=0, sticky="w", padx=10, pady=10)
        ...
        ctk.CTkLabel(self.tab_video, text="Codec:").grid(row=1, column=0, sticky="w", padx=10, pady=10)
    ...
    def _setup_audio_tab(self):
        # Audio Source Type
        ctk.CTkLabel(self.tab_audio, text="Audio Source Mode:", font=ctk.CTkFont(weight="bold")).pack(anchor="w", padx=10, pady=(10, 5))
        ...
        ctk.CTkLabel(self.tab_audio, text="Microphone Device:").pack(anchor="w", padx=10, pady=(10, 5))
        ...
        ctk.CTkLabel(self.tab_audio, text="System Device (Loopback):").pack(anchor="w", padx=10, pady=(10, 5))
